...
public class BaiduMapUtil {
	...
	public static List<BaiduPlace> searchPlace(String query, String lng, String lat) throws Exception {
		// 拼装请求地址
		String requestUrl = "http://api.map.baidu.com/place/v2/search?&query=QUERY&location=LAT,LNG&radius=2000&output=xml&scope=2&page_size=10&page_num=0&ak=skyWWcAYMVSgxEFWlbNHD21TrNtNxXVY";
	...
	public static List<Article> makeArticleList(List<BaiduPlace> placeList, String bd09Lng, String bd09Lat) {
		// 项目的根路径
		String basePath = "http://tx.llhvip.info/linkyoulink-1.0-SNAPSHOT/";
